...
import ru.stqa.pft.idsys.s.ru.id_sys.schemas.idbank.customer._2015._0.CustomerDataFilterItem;
import ru.stqa.pft.idsys.s.ru.id_sys.schemas.idbank.customer._2015._0.CustomerDocument;
...
@XmlSeeAlso({
    ...
    CommonDocument.BinaryDocument.class,
    CommonDocument.class,
    CommonDataFilterItem.class,
    Charge.Agents.Agent.class,
    Charge.class,
    Event.class
})
public class Object {
